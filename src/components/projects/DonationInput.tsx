...
export const CustomDonationInput: React.FC = (val)  => {
  ...
  <Container>
      ...
      <NumberInput maxW="100px" mr="2rem" value={value} onChange={handleChange}>
        ...
        <Slider aria-label="slider-ex-4" defaultValue={value} onChangeEnd={handleChange} size="sm" step={5} focusThumbOnChange={false}>
